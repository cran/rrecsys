...
%\VignetteIndexEntry{11. Extendind rrecsys}
-->
...
Rename _“yourAlgorithm.R”_ file in "rrecsys-mastet\\R\\" folder (if it isn't renamed it won't be build).
...
When you want to try out your implementation use devtools::load_all(".") or on RStudio’s toolbar menu Build>Load All, so that you can start using rrecsy’s methods.
...
Afteer step 5 your algorithm may be used with all the other methods available in rrecsys.
